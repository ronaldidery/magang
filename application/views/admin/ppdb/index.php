...
<div class="content-wrapper"> 
    ...
    <section class="content">
        ...
        <div class="card-body"> 
            ...
            <a href="<?= base_url(); ?>admin/ppdb/download_ijazah/<?= $value['id_pendaftar'];?>" class="btn bg-success"><i class="fas fa-image"></i></a>
            <a href="<?= base_url(); ?>admin/ppdb/download_kk/<?= $value['id_pendaftar'];?>" class="btn bg-success"><i class="fas fa-book"></i></a>
