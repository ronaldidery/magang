                ...
                foreach ($nilai as $value) : ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?= base_url(); ?>kelas7/hapuspas/<?= $value['id'];?>" class="btn bg-danger" onclick="return confirm('nilai akan dihapus?')" >hapus</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
...
<div class="modal fade" id="tambahModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <div class="modal-body">
        <form action="<?php echo base_url('kelas7/simpan_pas')?>" method="post" enctype="multipart/form-data">
...
<div class="modal fade" id="editModal<?=$value['id'];?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <div class="modal-body">
        <form action="<?php echo base_url(); ?>kelas7/simpan_edit_pas/<?php echo $value['id'];?>" method="post" enctype="multipart/form-data">
            <h4><strong>Identitas Siswa.</strong></h4>
            <hr>
            <h5>Nama Siswa:</h5>
