                ...
                foreach ($nilai as $value) : ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?= base_url(); ?>kelas9/hapuspts1/<?= $value['id'];?>" class="btn bg-danger" onclick="return confirm('nilai akan dihapus?')" >hapus</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
...
<div class="modal fade" id="tambahModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <div class="modal-body">
        <form action="<?php echo base_url('kelas9/simpan_pts')?>" method="post" enctype="multipart/form-data">
